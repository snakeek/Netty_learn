 ...
 * under the License.
 */
package com.mylearn.netty.sample.worldclock;
...
//        int port = Integer.parseInt(args[1]);
        Collection<String> cities = parseCities(1, "America");
//        if (cities == null) {
//            return;
//        }

        new WorldClockClient("localhost", 8080, cities).run();
    }
    ...
    private static List<String> parseCities(int offset, String... args) {
